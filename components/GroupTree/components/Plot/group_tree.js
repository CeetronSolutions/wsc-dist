...
export default class GroupTree {
     ...
     */
    constructor(dom_element_id, tree_data, defaultFlowrate, defaultNodeInfo, currentDateTime, edge_options, node_options) {
        // Add "#" if missing.
        ...
        options.forEach((key) => {
            ...
            this._propertyToLabelMap.set(key.name, [
                (_a = key.label) !== null && _a !== void 0 ? _a : "",
                (_b = key.unit) !== null && _b !== void 0 ? _b : "",
            ]);
        });
    ...
    update(newDateTime) {
        ...
        const newTree = cloneExistingNodeStates(growNewTree(this._renderTree(root.tree), this._width), this._currentTree);
...
//# sourceMappingURL=group_tree.js.map