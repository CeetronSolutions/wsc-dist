...
class ImageOverlayWebGL extends Component {
    render() {
        if (typeof this.props.colormap === "undefined") {
            return (React.createElement(ImageOverlay, { url: this.props.url, bounds: this.props.bounds }));
        }
        ...
        image.onload = () => {
            ...
            this.original_data.ImageData = ctx.getImageData(0, 0, offscreen_canvas.width, offscreen_canvas.height);
            this.original_data.loaded = true;
        };
        image.src = this.props.url;
        return (React.createElement(CanvasOverlay, { drawMethod: (canvas) => alter_image(canvas, this.props.url, this.props.colormap, this.props.hillShading, this.props.elevationScale, this.props.lightDirection), bounds: this.props.bounds, original_data: this.original_data, minvalue: this.props.minvalue, maxvalue: this.props.maxvalue, unit: this.props.unit }));
    }
}
...
//# sourceMappingURL=ImageOverlayWebGL.react.js.map