...
class Switch extends MapControl {
    ...
    render() {
        return ReactDOM.createPortal(React.createElement("div", { style: { paddingLeft: "10px", paddingRight: "10px" } },
            React.createElement(MaterialSwitch, { onClick: this.handleChange.bind(this), checked: this.state.checked }),
            this.props.label), this.panelDiv);
    }
}
Switch.propTypes = {
...
//# sourceMappingURL=Switch.react.js.map