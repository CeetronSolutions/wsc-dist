...
class LeafletMap extends Component {
    constructor(props) {
        ...
        this.setEvents = (map) => {
            map.on("zoomanim", (e) => {
                this.props.syncedMaps.forEach((id) => {
                    ...
                    if (e.zoom !== LeafletMap.mapReferences[id].getMap().getZoom()) {
        ...
        this.drawLayerAdd = (newLayers) => {
            this.setState((prevState) => ({
                drawLayerData: [...prevState.drawLayerData, ...newLayers],
            }));
        };
        this.drawLayerDelete = (layerTypes) => {
            if (layerTypes === "all") {
        ...
        this.syncedDrawLayerAdd = (newLayers) => {
        ...
        this.syncedDrawLayerDelete = (layerTypes, shouldRedraw) => {
            ...
            LeafletMap.syncedDrawLayer.data =
                LeafletMap.syncedDrawLayer.data.filter((drawing) => {
                    return (!syncedMaps.includes(drawing.creatorId) ||
         ...
         */
        this.setFocucedImageLayer = (layer) => {
            this.setState({
    ...
    render() {
        return (React.createElement("div", { style: { height: "100%", width: "100%" } },
            React.createElement("div", { ref: (el) => (this.mapEl = el), style: { height: "100%" } },
                React.createElement(Context.Provider, { value: {
                    ...
                    this.state.map && (React.createElement(Controls, { setProps: this.setPropsExist, map: this.state.map, scaleY: this.props.scaleY, switch: this.props.switch, colorBar: this.props.colorBar, unitScale: this.props.unitScale, drawTools: this.props.drawTools, mouseCoords: this.props.mouseCoords, syncDrawings: this.props.syncDrawings })),
                    this.state.map && (React.createElement(CompositeMapLayers, { layers: this.props.layers, map: this.state.map, syncedMaps: [
                            ...this.props.syncedMaps,
                            this.state.id,
                        ], syncDrawings: this.props.syncDrawings, updateMode: this.props.updateMode, setProps: this.setPropsExist }))))));
    }
}
LeafletMap.mapReferences = {};
LeafletMap.syncedDrawLayer = {
    data: [],
};
