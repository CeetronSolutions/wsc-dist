...
export const loadShader = (shaderPath) => fetch(shaderPath).then((res) => res.text());
...
export const createAndInitProgram = (gl, shaderVertex, shaderFragment) => {
    // Initialize shaders
    const program = createProgram(gl, createShader(gl, gl.VERTEX_SHADER, shaderVertex), createShader(gl, gl.FRAGMENT_SHADER, shaderFragment));
    // Initialize program
