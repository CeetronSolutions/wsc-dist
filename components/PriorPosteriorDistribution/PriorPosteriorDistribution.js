...
class PriorPosteriorDistribution extends Component {
    componentDidMount() {
        this.d3priorposterior = new D3PriorPosterior(this.props.height, this.props.id, this.props.data);
        this.d3priorposterior.renderPlot();
        window.addEventListener("resize", () => this.d3priorposterior.renderPlot());
    }
...
//# sourceMappingURL=PriorPosteriorDistribution.js.map