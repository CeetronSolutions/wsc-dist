...
import { COORDINATE_SYSTEM, FirstPersonView, MapView, OrbitView, OrthographicView, } from "@deck.gl/core/typed";
...
export default {
    ...
    classes: Object.assign(Object.assign({ FirstPersonView,
        MapView,
        OrbitView,
        OrthographicView }, CustomViews), 
    // a map of all layers that should be exposes as JSONLayers
    Layers, AggregationLayers, GeoLayers, MeshLayers, CustomLayers, 
