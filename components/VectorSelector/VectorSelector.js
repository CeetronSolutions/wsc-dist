...
const VectorSelector = (props) => {
    return React.createElement(VectorSelectorComponent, Object.assign({}, props));
};
...
VectorSelector.propTypes = {
     ...
     */
    customVectorDefinitions: PropTypes.objectOf(PropTypes.shape({
...
//# sourceMappingURL=VectorSelector.js.map