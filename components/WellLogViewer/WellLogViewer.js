...
export const argTypesWellLogViewerProp = Object.assign(Object.assign({}, argTypesWellLogViewScrollerProp), { readoutOptions: {
...
class WellLogViewer extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidUpdate(prevProps /*, prevState: State*/) {
        ...
        this.props.colorTables !== prevProps.colorTables*/) {
            ...
            if (this.props.template && this.props.template.scale.primary) {
                ...
                else if (this.props.welllog === prevProps.welllog)
    ...
    onInfoGroupClick(trackId) {
        ...
        this.updateReadoutPanel();
        if (this.controller)
            this.controller.selectContent(this.controller.getContentSelection()); // force to update readout panel
    }
    render() {
        const maxContentZoom = 256;
        return (React.createElement("div", { style: { height: "100%", width: "100%", display: "flex" } },
            React.createElement(WellLogViewWithScroller, { welllog: this.props.welllog, template: this.props.template, colorTables: this.props.colorTables, wellpick: this.props.wellpick, horizontal: this.props.horizontal, maxContentZoom: maxContentZoom, primaryAxis: this.state.primaryAxis, axisTitles: this.props.axisTitles, axisMnemos: this.props.axisMnemos, options: this.props.options, onInfo: this.onInfo, onCreateController: this.onCreateController, onTrackMouseEvent: onTrackMouseEvent, onContentRescale: this.onContentRescale, onContentSelection: this.onContentSelection, onTemplateChanged: this.onTemplateChanged }),
            React.createElement("div", { style: {
                ...
                React.createElement(InfoPanel, { header: "Readout", onGroupClick: this.onInfoGroupClick, infos: this.state.infos }),
                ...
                React.createElement("div", { style: { paddingLeft: "10px", display: "flex" } },
                    ...
                    React.createElement("span", { style: {
                        ...
                        React.createElement(ZoomSlider, { value: this.state.sliderValue, max: maxContentZoom, onChange: this.onZoomSliderChange }))))));
    }
}
///
...
//# sourceMappingURL=WellLogViewer.js.map