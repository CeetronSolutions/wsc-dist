...
const ComponentCode = '<WellLogViewer id="WellLogViewer" \r\n' +
    "    horizontal=false \r\n" +
...
export default {
    ...
    argTypes: Object.assign(Object.assign({}, argTypesWellLogViewerProp), { id: {
...
const Template = (args) => {
    ...
    return (React.createElement("div", { style: { height: "92vh", display: "flex", flexDirection: "column" } },
        React.createElement("div", { style: { width: "100%", height: "100%", flex: 1 } },
            React.createElement(WellLogViewer, Object.assign({ id: "WellLogViewer" }, args, { onCreateController: onCreateController, onContentRescale: onContentRescale, onContentSelection: onContentSelection }))),
...
Horizontal.args = {
    ...
    horizontal: true,
    welllog: require("../../../demo/example-data/WL_RAW_AAC-BHPR-CAL-DEN-GR-MECH-NEU-NMR-REMP_MWD_3.json")[0],
...
//# sourceMappingURL=WellLogViewer.stories.js.map