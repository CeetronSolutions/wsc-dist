...
export default {
    ...
    argTypes: Object.assign(Object.assign({}, argTypesWellLogViewScrollerProp), { id: {
...
const Template = (args) => {
    return (React.createElement("div", { style: { height: "92vh", display: "flex", flexDirection: "column" } },
        React.createElement("div", { style: { width: "100%", height: "100%" } },
            React.createElement(WellLogViewWithScroller, Object.assign({ id: "WellLogViewWithScroller" }, args)))));
};
...
//# sourceMappingURL=WellLogViewWithScroller.stories.js.map