...
class Colormap extends MapControl {
    ...
    render() {
        return ReactDOM.createPortal(React.createElement("div", { className: "leaflet-colorbar" },
            React.createElement("div", { className: "leaflet-colorbar-image" },
                React.createElement("img", { src: this.props.colormap, style: { width: "100%", height: "10px" } })),
...
//# sourceMappingURL=Colormap.react.js.map