...
class DrawControls extends Component {
    ...
    render() {
        ...
        return (React.createElement(EditControl, { ref: "edit", position: "topright", onEdited: this._onEdited.bind(this), onCreated: this._onCreated.bind(this), draw: {
                rectangle: false,
                circle: false,
                circlemarker: false,
                polygon: drawPolygon,
...
//# sourceMappingURL=DrawControls.react.js.map