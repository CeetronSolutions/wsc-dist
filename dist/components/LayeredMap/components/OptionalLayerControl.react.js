...
class OptionalLayerControl extends React.Component {
    render() {
        return this.props.showLayersControl ? (React.createElement(LayersControl, { position: "topright", hideSingleBase: true }, this.props.children)) : (this.props.children);
    }
}
...
//# sourceMappingURL=OptionalLayerControl.react.js.map