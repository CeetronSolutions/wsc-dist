...
class VerticalZoom extends MapControl {
    ...
    render() {
        return ReactDOM.createPortal(React.createElement(Slider, { orientation: "vertical", valueLabelDisplay: "auto", defaultValue: 1, min: this.props.minScaleY, max: this.props.maxScaleY, onChange: this.handleChange.bind(this) }), this.panelDiv);
    }
}
...
//# sourceMappingURL=VerticalZoom.react.js.map