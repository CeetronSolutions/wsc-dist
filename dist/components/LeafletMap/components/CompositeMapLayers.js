...
// Utils
import { makePolyline, makePolygon, makeCircle, makeMarker, makeCircleMarker, addImage, addTile, } from "../utils/leaflet";
// Helper functions
const yx = ([x, y]) => {
    return [y, x];
};
...
class CompositeMapLayers extends Component {
    constructor(props) {
        ...
        this.createLayerGroup = (layer) => {
            ...
            const checkedAsImageLayer = layer.checked &&
                layer.baseLayer &&
                layer.data.length > 0 &&
...
//# sourceMappingURL=CompositeMapLayers.js.map