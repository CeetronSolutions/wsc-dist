...
const ColorBar = (props) => {
    ...
    return ReactDOM.createPortal(React.createElement("div", { className: "leaflet-colorbar" },
        React.createElement("div", { className: "leaflet-colorbar-image" }, colorMap && (React.createElement("img", { key: colorMap, src: colorMap, style: { width: "100%", height: "10px" } }))),
        React.createElement("div", null,
            minMaxValue[0].toFixed(2),
            " ",
            unit),
        React.createElement("div", { className: "leaflet-colorbar-right-label" },
            minMaxValue[1].toFixed(2),
            " ",
            unit)), control.panelDiv);
};
ColorBar.propTypes = {
