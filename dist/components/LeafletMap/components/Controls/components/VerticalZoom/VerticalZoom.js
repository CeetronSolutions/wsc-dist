...
class VerticalZoom extends React.Component {
    ...
    render() {
        ...
        return ReactDOM.createPortal(React.createElement(Slider, { orientation: "vertical", valueLabelDisplay: "auto", defaultValue: 1, min: this.props.minScaleY, max: this.props.maxScaleY, onChange: this.onSliderValueChange }), this.state.verticalZoomCtrl.panelDiv);
    }
}
...
//# sourceMappingURL=VerticalZoom.js.map