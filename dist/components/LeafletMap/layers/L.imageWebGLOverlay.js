...
L.ImageWebGLOverlay = L.Layer.extend({
    ...
    initialize: function (url, bounds, options) {
        this._url = url;
        Util.setOptions(this, Object.assign(Object.assign({}, options), { url }));
    ...
    updateOptions: function (options) {
        ...
        options = Util.setOptions(this, Object.assign(Object.assign({}, this.options), options));
        // Update the URL
    ...
    _initUrl: function () {
        ...
        if (this.options.imageScale && imageScale > 0.0 && imageScale !== 1.0) {
            ...
            return Utils.scaleImage(this.options.url, imageScale, imageScale).then((scaledImageUrl) => {
    ...
    _draw: function () {
        ...
        drawFunc(this._gl, this._canvas, this._url, this._colormapUrl, Object.assign(Object.assign({}, this.options), { shader: this.options.shader, crossOrigin: this.options.crossOrigin || "" }))
            .then(() => {
    ...
    _calcBounds: function () {
        ...
        return new Bounds(this._map.latLngToLayerPoint(northWest), this._map.latLngToLayerPoint(southEast));
    },
...
//# sourceMappingURL=L.imageWebGLOverlay.js.map