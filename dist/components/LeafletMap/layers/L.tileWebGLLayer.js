...
L.TileWebGLLayer = L.GridLayer.extend({
    ...
    updateOptions: function (options) {
        Util.setOptions(this, Object.assign(Object.assign({}, this.options), options));
        this._initColormap();
        if (this.options.drawStrategy === DRAW_STRATEGY_FULL) {
            this._drawAllTiles();
        }
    ...
    _draw: function (tile, coords, done) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            drawFunc(this._glContext, this._canvas, this.getTileUrl(coords), this._colormapUrl, drawOptions).then(() => {
    ...
    _drawAllTiles: function () {
        return __awaiter(this, void 0, void 0, function* () {
            const drawOptions = this._getDrawOptions();
            const tiles = Object.values(this._tiles || {})
                .filter((tile) => tile.current)
                .map((tile) => (Object.assign(Object.assign({}, tile), { image: this.getTileUrl(tile.coords) })));
            // Merge the tiles into a single image
            const { url, size, minX, minY } = yield tilesToImage(tiles, drawOptions);
            // Draw image
            drawFunc(this._glContext, this._canvas, url, this._colormapUrl, drawOptions).then(() => {
    ...
    _getDrawOptions: function () {
        return Object.assign(Object.assign({}, this.options), { crossOrigin: "" });
    },
...
//# sourceMappingURL=L.tileWebGLLayer.js.map