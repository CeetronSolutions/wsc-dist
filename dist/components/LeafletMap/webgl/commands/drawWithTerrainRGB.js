 ...
 */
export default (gl, canvas, loadedImage, loadedColorMap, options = {}) => __awaiter(void 0, void 0, void 0, function* () {
    const { minValue = 0.0, maxValue = 0.0, 
    // ColorScale type
    applyColorScale = true, scaleType = "linear", remapPointMin = 0.0, remapPointMax = 1.0, cutPointMin = 0.0, cutPointMax = 1.0, 
    // Hillshading options
    applyHillshading = true, elevationScale = DEFAULT_ELEVATION_SCALE, sunDirection = DEFAULT_SUN_DIRECTION, ambientLightIntensity = DEFAULT_AMBIENT_LIGHT_INTENSITY, diffuseLightIntensity = DEFAULT_DIFFUSE_LIGHT_INTENSITY, } = options;
...
//# sourceMappingURL=drawWithTerrainRGB.js.map