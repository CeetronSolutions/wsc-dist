...
export class Vector {
     ...
     */
    get magnitude() {
        return Math.sqrt(this._data.map((x) => Math.pow(x, 2)).reduce((a, b) => a + b));
    }
    /**
...
export class Matrix {
     ...
     */
    scalarMultiply(scalar) {
        return new Matrix(this._data.map((d) => d.map((e) => scalar * e)), true, this._length, this._rowLength);
    }
    /**
     * @param {Vector} vector - A vector to multiply with.
...
//# sourceMappingURL=linear_algebra.js.map