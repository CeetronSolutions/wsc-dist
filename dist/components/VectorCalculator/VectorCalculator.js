...
import { ExpressionTypePropTypes, ExternalParseDataPropTypes, } from "./utils/VectorCalculatorTypes";
...
export const VectorCalculator = (props) => {
    return (React.createElement(StoreProvider, { initialExpressions: props.expressions },
        React.createElement(VectorCalculatorComponent, Object.assign({}, props))));
};
...
VectorCalculator.propTypes = {
     ...
     */
    expressions: PropTypes.arrayOf(PropTypes.shape(ExpressionTypePropTypes).isRequired).isRequired,
    /**
...
//# sourceMappingURL=VectorCalculator.js.map