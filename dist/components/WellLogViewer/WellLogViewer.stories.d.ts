...
declare namespace _default {
    export { WellLogViewer as component };
...
export namespace Default {
    namespace args {
        ...
        export { axisTitles };
        export { axisMnemos };
        export const viewTitle: boolean;
        export namespace options {
            const hideTrackTitle: boolean;
            const hideTrackLegend: boolean;
        }
    }
}
export function Horizontal(args: any): JSX.Element;
...
export namespace Discrete {
    export namespace args_2 {
        const id_2: string;
        export { id_2 as id };
        const horizontal_2: boolean;
        export { horizontal_2 as horizontal };
        const welllog_2: {
            header: {
                name: string;
                well: string;
        ...
        export { axisTitles };
        export { axisMnemos };
        const viewTitle_2: boolean;
        export { viewTitle_2 as viewTitle };
    }
