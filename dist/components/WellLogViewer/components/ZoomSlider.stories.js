...
const Template = (args) => {
    return (React.createElement("div", { style: { height: "92vh" } },
        React.createElement("div", { style: { width: "97%", height: "100%", flex: 1 } },
            "Zoom:",
            React.createElement(ZoomSlider, Object.assign({ id: "ZoomSlider" }, args)))));
};
...
//# sourceMappingURL=ZoomSlider.stories.js.map